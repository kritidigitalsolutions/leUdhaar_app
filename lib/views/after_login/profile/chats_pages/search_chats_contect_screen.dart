...
class _UnregisteredTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final displayName =
        localContact?.displayName ?? contact.inputPhone ?? 'Unknown';
        ...
        children: [
          ...
          Stack(
            children: [
              CircleAvatar(
                radius: 24,
                backgroundColor: const Color(0xFFE4E1DB),
                child: Text(
                  initials,
                  style: text14(
                    fontWeight: FontWeight.w700,
